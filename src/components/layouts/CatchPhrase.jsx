...
const catchPhrase = () => {
  return (
    <div
      ...
      className="hidden lg:block flex-shrink-0 text-4xl font-Assistant font-semibold text-left p-6 py-32 uppercase m-auto h-90 items-stretch w-1/2 bg-tertiaire-color"
    >
